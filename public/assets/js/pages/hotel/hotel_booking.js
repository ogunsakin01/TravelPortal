$(function(){
    ...
    $('input[name="use_logged_in_user"]').on('click',function(){
        if($(this).is(':checked')){
            axios.get(baseUrl+'/get-logged-in-user')
                .then(function(response){
                    $('.booking_sur_name').val(response.data.sur_name);
                    $('.booking_first_name').val(response.data.first_name);
                    $('.booking_other_name').val(response.data.other_name);
                    $('.booking_email').val(response.data.email);
                    $('.booking_phone').val(response.data.phone_number);
                    $('.booking_title_id').val(response.data.title_id);
                })
        }else{
            $('.booking_sur_name').val('');
            $('.booking_first_name').val('');
            $('.booking_other_name').val('');
            $('.booking_email').val('');
            $('.booking_phone').val('');
            $('.booking_title_id').val(1);
        }
    });
});