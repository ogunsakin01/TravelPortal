<link rel="apple-touch-icon" href="{{asset('backend/app-assets/images/ico/favicon.png')}}">
<link rel="shortcut icon" type="image/x-icon" href="{{asset('backend/img/core-img/favicon.png')}}">
<link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i|Quicksand:300,400,500,700" rel="stylesheet">
<link href="{{asset('backend/maxcdn.icons8.com/fonts/line-awesome/1.1/css/line-awesome.min.css')}}" rel="stylesheet">
<!-- BEGIN VENDOR CSS-->
...
<link rel="stylesheet" type="text/css" href="{{asset('backend/app-assets/css/plugins/file-uploaders/dropzone.min.css')}}">
