...
@section('page-title') All Travel-package @endsection
            ...
            <div class="col-md-2 col-sm-2">
                <div class="user-profile-tabs">
                    <ul class="nav nav-tabs">
                        <li class="active"><a  href="{{ url('setting/travel-package') }}" class="text-center"><i class="fa fa-th"></i> <span>All Travel Packages</span></a></li>
