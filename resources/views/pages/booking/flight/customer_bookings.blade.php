...
@section('page-title') Customer Flight Booking @endsection
            ...
            <div class="col-md-2 col-sm-2">
                <div class="user-profile-tabs">
                    <ul class="nav nav-tabs">
                        <li><a  href="{{ url('booking/flight/my_bookings') }}" class="text-center"><i class="fa fa-bolt"></i> <span>My Booking</span></a></li>
                        <li><a  href="{{ url('booking/flight/agent_bookings') }}" class="text-center"><i class="fa fa-history"></i> <span>Agent Booking</span></a></li>
                        <li class="active"><a href="{{ url('booking/flight/customer_bookings') }}" class="text-center"><i class="fa fa-user"></i> <span>Customer Booking</span></a></li>
